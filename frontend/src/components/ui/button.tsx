  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-background-card shadow-sm hover:bg-background-muted hover:text-foreground",
        secondary:
          "bg-background-muted text-foreground shadow-sm hover:bg-background-muted/80",
        ...
        urgency:
          "bg-urgency text-urgency-foreground shadow-sm hover:bg-urgency/90",
      },
      size: {
